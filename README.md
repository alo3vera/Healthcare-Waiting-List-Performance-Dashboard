...
* Waiting List Counts
* Archive Month for trend analysis
...
* Created relationships for efficient filtering and slicing
...
<img width="1279" height="720" alt="Detail Summary" src="Detailed view page.png" />
...
* The 18+ months time band holds the largest backlog across age groups
